...
module.exports = new PluginWebpackConfig('cn.qingmg.graylog.plugin.kafka.notification.KafkaNotificationPlugin', loadBuildConfig(path.resolve(__dirname, './build.config')), {
